...
<div class="content-pages-wrap">
    ...
    <table border="0" cellspacing="1" cellpadding="0" class="commonTable">
        <form id="institutionCreat" name="institutionCreat" action="<%=basePath %>institutionupdate" method="post">
        <p><input type="hidden" name="orgid" value="<%=request.getParameter("id") %>"></p>
        <tr>
        ...
        <tr>
            ...
            <td align="left" colspan="4">
            	<input type="radio" name="exetype" id="radio5" value="1" />行政部门
                <input type="radio" name="exetype" id="radio6" value="2" />卫生监督机构
