...
public class institutionCreatServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		int i;
		int j;
		String orgid = Long.toString(System.currentTimeMillis());
		...
		i = creatorg.creatorg(orgid,orgno,orgcode,orgname,exetype,areacode,linkadd,listingdate,standalonedate,areatype,zbbdocdate,orglevel,orgpro,zipcode);
		j = createquip.createquipment(id,orgid,orgname,orgno,orgcode,onworkernum,supervisornum,zbbnum,ifpublicmanage,retirenum,officebuildarea,buildingownership,officebuildingarea,businessdivcount,fundivcount,orgcount,equ3count,equ2count,equ1count,buscount,rapidtestvehiclecount,motorcount,cameracount,videocount,copycatnum,computernum,notepadnum,servercount,pbxcount,faxcount,ohpcount,vrcount);
